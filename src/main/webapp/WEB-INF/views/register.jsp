        ...
        function checkusername() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {  document.getElementById("span1").innerHTML="用户名不可用"; }
                    else
                        {
...
//                dataType: "application/json",
                ...
                success: function (data) {
                   ...
                   switch (data)
                    {
                        case "success":alert("注册成功"); window.location.href="login";break;
                        case "false":alert("注册失败");break;
                        case "worrong_activation_code":alert("激活码错误");break;
                        case "wrrong_code":alert("验证码错误");break;
                        default :alert("其他情况");break;
                ...
                <form id="registerForm">
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                <input  onblur="checkusername()" type="text" id="username" name="username" class="text" maxlength="20">
                                <span id="span1"></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>
                                <span class="requiredField">*</span>邮箱验证码:
                            </th>
                            <td>
                                <input type="text" name="code" class="text"/> <input type="button" class="button" value="发送邮箱验证码"onclick="sendmail()"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="picture_code" class="text captcha" maxlength="4" autocomplete="off"><img onclick="change()" id="Images" class="captchaImage" src="${pageContext.request.contextPath}/picture" title="点击更换验证码">
										</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="button" class="submit" onclick="Register()" value="同意以下协议并注册">
                            </td>
                        </tr>
                        <tr>
                            <th>&nbsp;
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" src="${pageContext.request.contextPath}/" frameborder="0" border="0" scrolling="no"></iframe></div></body></html>